(async () => {
    ...
    const chartSurface = document.getElementById('dashboard-chart-surface');
    ...
    const detailChartSurface = document.getElementById('dashboard-detail-chart-surface');
    ...
    const renderChartSvg = (surfaceNode, linePath, points) => {
        surfaceNode.innerHTML = `
            <svg class="dashboard-chart-svg" viewBox="0 0 720 224" preserveAspectRatio="none">
        ...
        return surfaceNode.querySelector('svg');
    };
    ...
    const renderChart = (series, options = {}) => {
        ...
        const svgNode = renderChartSvg(surfaceNode, linePath, points);
    ...
    const renderMonthlyDetail = () => {
        ...
        renderChart(series, {
            ...
            surfaceNode: detailChartSurface,
